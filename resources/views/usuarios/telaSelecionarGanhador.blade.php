...
@section('titulo'){{ config('app.name') }} - Realizar Pagamento Para Usuário @endsection
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									Selecionar Usuário Para Pagamento de Prêmio
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							...
							<div class="col-xs-12">										
							<form class="form-horizontal" role="form" id="formPremio" name="formPremio" method="GET" action="{{ route('usuarios.telaPremioDetalhe') }}">
									{{ csrf_field() }}
									<input type="hidden" name="id_ranking" id="id_ranking" value="{{$tipoRanking->id}}" />
										<div class="clearfix">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                								...
                								<tbody>
                									...
                									<tr>
                										<td>
                										<input type="radio" name="id_usuario" id="id_usuario_{{$ranking['id_user']}}" value="{{$ranking['id_user']}}" />
                										</td>
