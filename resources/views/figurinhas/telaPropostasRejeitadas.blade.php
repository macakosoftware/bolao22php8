...
@section('titulo'){{ config('app.name') }} - Propostas Rejeitadas @endsection
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Visualizar Propostas Rejeitadas
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							...
							<form class="form-horizontal" role="form" id="formPropostas" name="formPropostas" method="GET" action="{{ route('figurinhas.consultaProposta') }}">
									{{ csrf_field() }}
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>	
														<th>&nbsp;</th>													
														<th>Usuário Rejeição</th>
														<th>Figurinha</th>
														<th>Valor Troca</th>
														<th>Qtd.Figurinhas Troca</th>
														<th>Data/Hora</th>														
													</tr>
												</thead>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															{{number_format($proposta->vl_proposta,2,',','')}}
															@else
															&nbsp;
															@endif
														</td>														
														<td>
															{{ count($proposta->jogadoresTroca) }}
														</td>														
														<td>
															{{$proposta->updated_at}}
														</td>										
