...
<div class="main-content">
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				<li><i class="menu-icon fa fa-book"></i> Figurinhas <i
					class="menu-icon fa fa-search"></i> Consulta Proposta</li>
		...
		<div class="page-content">
			...
			<div class="col-xs-12">
				<h2>@if ($proposta->cd_status == \App\Models\TransacaoProposta::STATUS_ACEITA) <span style="color:green">ACEITA</span> @else <span style="color:red">REJEITADA</span> @endif</h2>
				<h4>Figurinha da Proposta</h4>
				<p>
				<img width="30" height="45" alt="40x60" src="{{url('figurinhas/mostrar')}}?id_jogador={{$proposta->transacao->jogador->id}}" />
				{{ $proposta->transacao->jogador->ds_nome }}
				</p>				
				<h4>Usuário enviado Proposta</h4>
				<p>
			...
			<div class="row">
				...
				<div class="col-xs-12">
						...
						<div class="table-header">Figurinhas Ofertadas</div>
