				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<form class="form-horizontal" role="form" id="formPropor" name="formPropor" method="GET" action="{{ route('figurinhas.telaCriarProposta') }}">
									{{ csrf_field() }}
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															@if (\App\Funcoes\VerificaFigurinhaColecao::verificar(Auth::user(),$transacao->jogador))
														...
														<td>
															{{ count($transacao->propostas()->where('cd_status',\App\Models\TransacaoProposta::STATUS_ENVIADA)->get()) }}
														</td>
														<td>
