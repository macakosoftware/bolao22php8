				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->	
								{!! Form::open(array('route' => 'alterarPerfil', 'class' => 'form-horizontal', 'files' => true, 'name' => 'formPerfil', 'id' => 'formPerfil')) !!}
									{{ csrf_field() }}									
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="foto_profile"> Foto Perfil </label>
