@extends('template') @section('titulo'){{ config('app.name') }} - Editar
Palpites @endsection 
@section('header_css')
							...
							<table id="dynamic-table"
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<input type="hidden" name="id_penal_{{$jogo['id_jogo']}}" id="id_penal_{{$jogo['id_jogo']}}" value="{{$jogo['id_penal']}}" />
										@if($jogo['id_penal'])
										{!! Form::select('id_selecao_penal_'.$jogo['id_jogo'], $jogo['tb_times'], $jogo['id_selecao_penal'], $attributes = ['class'=>'col-xs-12 col-sm-12', 'tabindex'=>'-1']) !!}
										@endif
										</td>
											...
											<div class="hidden-md hidden-lg">
												<div class="inline pos-rel">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>
															<a href="$" class="tooltip-info" data-rel="tooltip" title="Placar Cheio" id="id-btn-dialog-total-m-{{$jogo['id_jogo']}}">
																<span class="blue">
														...
														<li>
															<a href="$" class="tooltip-info" data-rel="tooltip" title="Placar Parcial" id="id-btn-dialog-parcial-m-{{$jogo['id_jogo']}}">
																<span class="orange">
																	<i class="ace-icon fa fa-search-plus bigger-120"></i>
																</span>
															</a>
...
<script type="text/javascript">
			jQuery(function($) {
				...
				$( "#id-btn-dialog-total-m-{{$jogo['id_jogo']}}" ).on('click', function(e) {
					e.preventDefault();
				...
				$( "#id-btn-dialog-parcial-m-{{$jogo['id_jogo']}}" ).on('click', function(e) {
					e.preventDefault();
