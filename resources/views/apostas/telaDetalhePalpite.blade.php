			...
			<div class="page-header">
				<h1>
					Palpites <small> <i class="ace-icon fa fa-angle-double-right"></i>
						Palpites de {{$usuario_palpite->name}}
					</small>
				</h1>
			</div>
			<!-- /.page-header -->
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" id="formApostas"
						...
						<div class="table-header">Palpites de {{$usuario_palpite->name}}</div>
							...
							<table id="dynamic-table"
								...
								<thead>
									<tr>
										...
										<th>Fase</th>										
										<th>Seleção 1</th>
										<th class="center">Placar 1</th>
										<th class="center">X</th>
										<th class="center">Placar 2</th>
										<th>Seleção 2</th>
										<th>Penalty</th>
										<th>Pontos Máximo</th>										
								...
								<tbody>
									...
									<tr>
										<td>{{
											...
											@if ($jogo['cd_status'] == \App\StatusJogo::JOGO_FINALIZADO)
											<i class="ace-icon fa fa-flag bigger-130 green"></i>
    											@if ($jogo['id_happy'])
    											<i class="ace-icon fa fa-smile-o bigger-130 green"></i>
    											@else
    											<i class="ace-icon fa fa-frown-o bigger-130 red"></i>
    											@endif
											@else
										...
										<td>
										@if ($jogo['id_selecao_penal'] > 0)
										<img src="{{ asset('images/brasoes') }}/{{$jogo['ds_icone_penal']}}" />
										<span class="{{$jogo['class_penal']}}">
										{{$jogo['ds_selecao_penal']}}
										</span>										
										@endif
										@if ($jogo['id_mostra_penal'])										
										&nbsp;
										<label class="btn btn-xs btn-yellow">{{$jogo['ds_vencedor_penal']}}</label>
										@endif
										</td>										
										<td>
