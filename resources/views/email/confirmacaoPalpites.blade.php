...
<td class="table-row-fixed-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 24px; padding-right: 24px;" valign="top" align="left">
   ...
   <p>Olá {{$user->name}},</p>
   <br/>
   <p>Acabamos de registrar os seguintes palpites em seu nome:</p>
   <table>
   <tr>
   <th>Data/Hora</th>
   <th>Tipo Jogo</th>
   ...
   <tr>
   	...
   	<td>{{$aposta->jogo->tipoRanking->ds_nome}}</td>
   	<td align="left">
   	...
   	@if ($aposta->jogo->id_penal)
   		...
   		{{\App\Selecao::where('id',$aposta->id_selecao_penal)->first()->ds_nome}}
   		@else 
   		&nbsp;
   		@endif
   	@else
