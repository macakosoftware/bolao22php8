            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                <th class="small-12 large-12 columns first last"><table><tr><th>
                  ...
                  <p>OLá {{$user->name}},<br/>
                  Seus Palpites foram computados com êxito. Abaixo segue o resumo dos seus palpites para conferência.</p>
                  ...
                  <table class="callout"><tr><th class="callout-inner secondary">
                    <table class="row"><tbody><tr>
                      ...
                      <th class="small-3 large-1 columns first">
                      #                                              
                      </th>
                      <th class="small-3 large-1 columns first">
                      X                        
                    ...
                    <td>{{\Carbon\Carbon::parse($aposta->jogo->dt_jogo)->format('d/m/Y')}} / {{substr($aposta->jogo->hr_jogo, 0, 5)}}</td>
                    <td>
                   	<img src="{{ asset('images/brasoes') }}/{{$aposta->jogo->selecao1->ds_icone}}" />
                   	{{$aposta->jogo->selecao1->ds_nome}}
                   	</td>
                   	<td align="center">{{$aposta->qt_gols_selecao1}}</td>
                   	<td align="left">X</td>
                   	<td align="center">{{$aposta->qt_gols_selecao2}}</td>
                   	<td align="left">
                   	<img src="{{ asset('images/brasoes') }}/{{$aposta->jogo->selecao2->ds_icone}}" />
                   	{{$aposta->jogo->selecao2->ds_nome}}
                   	</td>
                    @endforeach
                    <tr>
                    </tr>
              ...
              <table class="row footer text-center"><tbody><tr>                
                <th class="small-12 large-6 columns"><table><tr><th>
                  <p>
                    {{ config('app.name') }}<br>
                    {{ config('app.url') }}
                  </p>
