...
@section('titulo'){{ config('app.name') }} - Consulta de Jogos @endsection
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>{{ \Carbon\Carbon::parse($jogo->dt_jogo)->format('d/m/Y')}} - {{substr($jogo->hr_jogo,0,5)}}</td>
														<td>{{ $jogo->tipoRanking->ds_nome }}</td>
														<td>@if ($jogo->tipoRanking->id_grupo) {{ $jogo->selecao1->grupo->ds_grupo }} @endif</td>
														<td>
