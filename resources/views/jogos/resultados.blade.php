...
@section('titulo'){{ config('app.name') }} - Resultados dos Jogos @endsection
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Manutenção do Resultado dos Jogos
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							...
							<div class="col-xs-12">	
										<form class="form-horizontal" role="form" id="formResultados" name="formResultados" method="POST" action="{{ route('jogos.resultados') }}">
										{{ csrf_field() }}
										{{ Form::hidden('ds_ids', $ds_ids) }}				
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><input type="text" id="placar1_{{$jogo->id}}" name="placar1_{{$jogo->id}}" class="input-mini" @if ($jogo->cd_status != \App\Models\StatusJogo::JOGO_PROGRAMADO) value="{{$jogo->qt_gols_selecao1}}" @endif/></td>
														<td>X</td>
														<td><input type="text" id="placar2_{{$jogo->id}}" name="placar2_{{$jogo->id}}" class="input-mini" @if ($jogo->cd_status != \App\Models\StatusJogo::JOGO_PROGRAMADO) value="{{$jogo->qt_gols_selecao2}}" @endif/></td>
														<td>
														...
														<td>
														@if($jogo->id_penal)
														<select name="id_penal_{{$jogo->id}}" id="id_penal_{{$jogo->id}}">
															<option value="0">Sem Penalties</option>
															<option value="{{$jogo->id_selecao1}}">{{$jogo->selecao1->ds_nome}}</option>
															<option value="{{$jogo->id_selecao2}}">{{$jogo->selecao2->ds_nome}}</option>
														</select>
														@else
														&nbsp;
														@endif
